...
class PersonalTableSeeder extends Seeder
{
    ...
    public function run()
    {
    	DB::table('personal')->insert([
    		'id' => 1 ,
    		'nombres' => 'Administrador Web',
    		'apellidos' => 'Administrador Web',
    		...
    		'nacionalidad' => 'Administrador Web',
    		'estado_civil' => 'Administrador Web',
    		'nivel_educativo' => 'Administrador Web',
    		'profesion' => 'Administrador Web',
    		'direccion' => 'Administrador Web',
    		'estado' => '1',
