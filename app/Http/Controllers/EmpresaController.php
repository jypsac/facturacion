...
=======
    ...
    //     cd laragon\www/74894537
    //     php artisan migrate:fresh
    //     php artisan migrate:fresh --seed';
    //     fwrite($migrate,$texto_migrate);
    //comando para importar en sql
    // mysql -u root -e facturacion_74894537><C:\laragon\www\puntos_bat\data.sql ;
        // B-Correr el Archivo Bat
        // exec('c:\WINDOWS\system32\cmd.exe /c START C:\laragon\www/puntos_bat/php_fresh_'.$nombre.'.bat');
         $bat_migra='start /b  C:\laragon\www/puntos_bat/php_fresh_74894537.bat';
