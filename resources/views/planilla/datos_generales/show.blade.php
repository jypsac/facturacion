...
<style>
  ...
  input#archivoInput{  position:absolute;height: 90px; opacity: 0 ;}
</style>
<div>
  <div class="jumbotron fondo_perfil">
    <div class="row justify-content-md-center"  id="superior_vista_dg">

      <div class="col-lg-3"><img src="{{ asset('/profile/images/')}}/{{$personales->foto}}" class="rounded-circle circle-border m-b-md"></div>
   ...
   <div class="row justify-content-md-center" id="superior_form_dg" hidden="">
    ...
    <div class="col-lg-3">{{--  <img src="{{ asset('/profile/images/')}}/{{$personales->foto}}" class="rounded-circle circle-border m-b-md"> --}}
...
<div class="col-lg-7" style="padding-top:10px">
  <div class="row justify-content-md-center" align="center" >
   ...
   <div class="col col-lg-6" style="padding-top:10px"> <input class="form-control show" type="text" id="nacionalidad1" value="{{$personales->nacionalidad}}"  onkeyup="PasarValor();"></div>
 </div>
...
<div class="fh-column" >
  <div align="left"> <button class="btn btn-lg btn-success" onclick="editar_datos_generales()" id="boton_datos_generales" ><i class="fa fa-edit"></i></button></div>
...
<input  type="file"   name="fotow" accept="{{asset('/profile/images')}}/{{$personales->foto}}">
...
<div class="full-height">
  <div align="left"> <button class="btn btn-lg btn-success" onclick="editar_datos_laborables()" id="boton_datos_laborables" ><i class="fa fa-edit"></i></button></div>@if(isset($persona->id))
...
<script>
  ...
  function editar_datos_generales() {
    ...
    if( datos_generales_vista.hasAttribute("hidden") )
    {
      ...
      boton_datos_generales.innerHTML='<i class="fa fa-edit"></i> ';
      ...
      boton_datos_generales.innerHTML='Cancelar';
      boton_datos_laborables.innerHTML='<i class="fa fa-edit"></i> ';
  ...
  function editar_datos_laborables() {
    if( vista_datos_laborables.hasAttribute("hidden") )
    {
      ...
      boton_datos_laborables.innerHTML='Cancelar';
      boton_datos_generales.innerHTML='<i class="fa fa-edit"></i> ';
