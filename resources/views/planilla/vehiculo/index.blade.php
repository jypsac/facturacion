                ...
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover dataTables-example" >
                            ...
                            <tbody>
                                @foreach($transporte_publico as $transporte_publico)
                                <tr>
                                   <td>{{$transporte_publico->id}}</td>
                                   <td>{{$transporte_publico->nombre}}</td>
                                   <td>{{$transporte_publico->ruc}}</td>
                                   <td>
                                    @if($transporte_publico->estado_activo==0)Activo
                                    @elseif($transporte_publico->estado_activo==1)Desactivado
                                    @endif
                                </td>
                                <td><a href="#exampleModal{{$transporte_publico->id}}" data-toggle="modal" class="btn btn-info">Editar</a>

                                    <!-- Modal Create  -->

                                    <div class="modal fade" id="exampleModal{{$transporte_publico->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel"> Vehiculo</h5>
                                                ...
                                                <div style="padding-left: 15px;padding-right: 15px;">
                                                    ...
                                                    <div class="ibox-content" style="padding-left: 0px;padding-right: 0px;" align="center">
                                                     ...
                                                     <form action="{{route('vehiculo.update',$transporte_publico->id)}}"  enctype="multipart/form-data" method="post">
                                                        @csrf
                                                        @method('PATCH')
                                                        <fieldset >
                                                            <legend> Agregar Vehiculo </legend>
