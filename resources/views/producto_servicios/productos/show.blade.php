...
<div class="row">
 ...
 <div class="col-sm-4"><input type="text" class="form-control" name="garantia"  value="{{$producto->garantia}}"  disabled="disabled">
 </div>

 <label class="col-sm-2 col-form-label">Stok Minimo:</label>
 <div class="col-sm-4"><input type="text" class="form-control" name="stock_minimo" value="{{$producto->stock_minimo}}"  disabled="disabled" >
 </div>
