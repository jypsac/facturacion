...
@section('breadcrumb', 'Familia-Editar')
@section('breadcrumb2', 'Familia-Editar')
				...
				<div class="ibox-content">
					<form action="{{ route('familia.update',$familia->id) }}"  enctype="multipart/form-data" method="post">
					 	...
					 	<div class="form-group  row"><label class="col-sm-2 col-form-label">Codigo:</label>
		                     <div class="col-sm-10"><input type="text" class="form-control" name="codigo" value="{{$familia->codigo}}"></div>
		                </div>

		                <div class="form-group  row"><label class="col-sm-2 col-form-label">Descripcion:</label>
		                     <div class="col-sm-10"><input type="text" class="form-control" name="descripcion" value="{{$familia->descripcion}}"></div>
		                </div>
