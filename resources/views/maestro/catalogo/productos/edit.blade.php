				...
				<div class="panel panel-default">
					<div class="panel-body" align="left">
						<div class="row">
							...
							<div class="col-sm-4"><input type="text" class="form-control" value="{{$producto->codigo_producto}}" disabled="disabled">
                    		</div>
                 ...
                 <input type="text" class="form-control" name="utilidad" value="{{$producto->utilidad}}"  >
					...
					<div class="row">
						...
						<div class="row">
                              ...
                              <div class="col-sm-2"><input type="text" class="form-control" name="garantia"  value="{{$producto->garantia}}"  >
                    		</div>
