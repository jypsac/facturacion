...
@section('href_accion', route('almacen.create'))
                                    ...
                                    <td>
                                        <center>
                                            <form action="{{route('almacen.destroy',$almacen->id)}}" method="POST">
                                              @csrf
                                              @method('delete')
                                              <input type="text" name="desactivar" value="desactivar">
                                              <button type="submit" class="btn btn-w-m btn-danger">desactivar</button>
                                            </form>
                                        </center>
                                  </td>
                              </tr>
