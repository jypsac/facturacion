                ...
                <div class="ibox-content">
                    ...
                    <script>
                        ...
                        $(".addmore").on('click', function () {
                            ...
                            <td>
                            <input type='number' style="width: 76px"  id='cantidad${i}' name='cantidad[]' max="{{$array_cantidad[$index]}}" class="monto${i} form-control" onkeyup="multi(${i})" required  autocomplete="off"/>
                            </td>
                            <td>
