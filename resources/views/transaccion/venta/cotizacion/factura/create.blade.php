            ...
            <div class="ibox">
                ...
                <script>
                    ...
                    $(".addmore").on('click', function () {
                        ...
                        <td>
                        <input type='number' style="width: 76px"  id='cantidad${i}' name='cantidad[]' class="monto${i} form-control" onkeyup="multi(${i})" required  autocomplete="off" max="{{$array_cantidad[$index]}}" min="1"/>
                        </td>
                        <td>
