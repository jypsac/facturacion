                        ...
                        <div class="col-sm-4 ">
                            <div class="form-control ruc" style="height: 125px">
                                <center>
                                    ...
                                    <input type="text" value="BO-000{{$suma}}" name="codigo_bol" hidden="hidden">
                        ...
                        <table class="table ">
                            <thead>
                                <tr>
                                    ...
                                    <td style="width: 200px" colspan="4"><input type="text" class="form-control" value="{{$cotizacion->cliente->nombre}}" readonly="readonly" ></td>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td><input type="text" class="form-control"  name="orden_compra"></td>
                                </tr>
                                <tr>
                                    <td><b>Condiciones de Pago</b></td>
                                    <td style="width: 3px">:</td>
                                    <td colspan="4"><input type="text" class="form-control" value="{{$cotizacion->forma_pago->nombre }}" readonly="readonly">
                                    <td><b>Guia Remision</b></td>
                                    <td style="width: 3px">:</td>
                                    <td><input type="text" class="form-control" name="guia_remision"></td>
                                </tr>
                                <tr>
                                    <td><b>Fecha Emision</b>
