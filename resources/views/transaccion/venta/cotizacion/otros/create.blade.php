            ...
            <div class="ibox">
                                    ...
                                    <table cellspacing="0" class="table tables  " >
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <input  class="form-control " name="articulo[]" class="monto0 form-control" required id='articulo' onkeyup="calcular(this,0);multi(0)"  autocomplete="off">
                                                    </td>
                ...
                <script>
                    ...
                    $(".addmore").on('click', function () {
                        ...
                        <td>
                        <input  class="form-control " name="articulo[]" required id='articulo${i}' onkeyup="calcular(this,${i});multi(${i});ajax(${i})" autocomplete="off">
                        </td>
                        <td>
