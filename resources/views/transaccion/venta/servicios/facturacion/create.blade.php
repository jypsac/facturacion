        ...
        <div class="col-lg-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    <form action="{{route('facturacion_servicio.store')}}"  enctype="multipart/form-data" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="row">
                                            <label class="col-sm-2 col-form-label">Monedas:</label>
                                            <div class="col-sm-8" style="">
                                                <input type="text" name="moneda" class="form-control " value=" {{$moneda->nombre}}" readonly="readonly">
                                            </div>
                                            <div class="col-sm-1">
                                                <a  href="{{route('facturacion_servicio.create_ms')}}">
