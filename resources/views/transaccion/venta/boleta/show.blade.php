        ...
        <div class="row tooltip-demo">
            <div class="col-sm-6">
             ...
             <div class="col-sm-6" align="right">
                <form class="btn" style="text-align: none;padding: 0 0 0 0" action="{{route('pdf_bol' ,$boleta->id)}}">
                ...
                <div id="div-mostrar">
                   <form action="{{route('agregado.whatsapp_send')}}" method="post" class="btn" style="text-align: none;padding-right: 0;padding-left: 0;">
                        @csrf
                         ...
                         <input type="text" hidden="" name="url" value="{{route('pdf_bol' ,$boleta->id)}}?archivo=">
                         <input type="text" name="name_sin_cambio" hidden="" value="Boleta_{{$boleta->codigo_boleta}}" />
