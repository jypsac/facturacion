        ...
        <div class="col-lg-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    <form action="{{route('boleta.store',[$moneda->id,$boleta_numero])}}" enctype="multipart/form-data" method="post" onsubmit="return valida(this)">
                        @csrf
                         @method('put')
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <div class="div table-responsive">
                                            ...
                                            <button class="btn btn-primary float-right" type="submit"><i class="fa fa-cloud-upload" aria-hidden="true" id="boton" >Guardar</i></button>&nbsp;
