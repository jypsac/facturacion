                ...
                <div class="row">
                    ...
                    <div class="col-sm-6" align="right">
                        <address class="col-sm-4" align="right">
                            <img src="{{asset('storage/marcas/'.$garantias_guias_egreso->garantia_ingreso_i->marcas_i->imagen)}}" alt="" width="300px" align="right">
                        </address>
                    </div>
                </div>
                <div class="row">
...
<div class="container">
    <div class="child1"><br>
        ...
        Ing. {{$garantias_guias_egreso->garantia_ingreso_i->personal_laborales->personal_l->nombres}}
